...
class JoinRule(BuildRule):
    ...
    def validate(self):
        ...
        left_vars = set(
            [v for v in left_args if isinstance(v, int) or isinstance(v, pddl.Variable)]
        )
        right_vars = set(
            [
                v
        ...
        eff_vars = set(
            [v for v in eff_args if isinstance(v, int) or isinstance(v, pddl.Variable)]
        )
